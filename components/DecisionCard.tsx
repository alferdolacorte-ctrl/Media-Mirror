...
/**
 * Decision point: choices as compact buttons; after choosing, shows chosen text as user-style bubble.
 * No free-form input. Immediate reveal is triggered by parent (advance state).
 */
    ...
    >
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          ...
          <div style={{ fontSize: 13, color: "#333333", lineHeight: 1.5 }}>
            {question}
          </div>
          {hasChoices && (
            <div
